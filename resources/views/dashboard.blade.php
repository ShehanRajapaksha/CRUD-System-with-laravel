          ...
          <div class="flex flex-wrap -m-4 text-center">
            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                ...
                <h2 class="title-font font-medium text-3xl text-gray-900">{{App\Models\listing::count()}}</h2>
...
document.getElementById("filter").addEventListener("click", filterResultsDash)
