            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8 w-full">
                    <div class="py-2 align-middle inline-block  sm:px-6 lg:px-8 w-full">
                        ...
                        <div class="flex justify-start">
                            <a href ="{{route('childcategories.index')}}"    class="py-2 px-4 m-2 bg-green-500 hover:bg-green-600 text-gray-50 rounded-md">Back</a>
                        </div>
                        <div class="h-4"></div>
                            ...
                            <div class="space-y-12">
                              <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                  <div class="sm:col-span-4">
                                    ...
                                    <div class="mt-2">
                                      <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        ...
                                        <input type="text" name="name" id="name"  class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value="{{$child_category->name}}">
                                        @error('name')
                                    ...
                                    <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Sub Category</label>
                                      ...
                                      <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                       ...
                                       <select name="sub_category_id" >
                                          ...
                                          <option value="{{$sub_category->id}}" {{$sub_category->id==$child_category->sub_category_id ?'selected':""}}>
                                  ...
                                  <div class="col-span-full">
                                    <label for="image" class="block text-sm font-medium leading-6 text-gray-900">Sub Category Image</label>
                                      ...
                                      <div class="text-center">
                                        ...
                                        <div class="sm:col-span-6">
                                            ...
                                            <div class="w-full m-2 p-2">
                                                <img src="{{Storage::url($child_category->image)}}" alt="" class="h-full w-full">
                                            </div>  
                                            <div class="mt-1">
