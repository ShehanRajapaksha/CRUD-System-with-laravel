<x-admin-layout>
    ...
    {{-- <div class="flex justify-end">
        <a href ="{{route('listings.create')}}"    class="py-2 px-4 m-2 bg-green-500 hover:bg-green-600 text-gray-50 rounded-md">New Category</a>
    </div> --}}
                    ...
                    <div class="container px-5 py-24 mx-auto">
                      ...
                      <div class="flex flex-wrap -m-4">
                        ...
                        <div class="lg:w-1/4 md:w-1/2 p-4 w-full m-2 ">
                          <a class="block relative h-48 rounded overflow-hidden" href="{{route('listings.edit',$listing->id)}}"> 
                            <img alt="ecommerce" class="object-cover object-center w-full h-full block" src="{{Storage::url($listing->featured_image)}}">
                          </a>
                          <div class="mt-4">
                            <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">{{$listing->title}}</h3>
                            <h2 class="text-gray-900 title-font text-lg font-medium">{{$listing->slug}}</h2>
                            <div class="flex justify-end">
