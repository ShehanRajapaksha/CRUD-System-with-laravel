<x-admin-layout>
    ...
    <div class="flex justify-end">
        <a href ="{{route('admin.categories.create')}}"    class="py-2 px-4 m-2 bg-green-500 hover:bg-green-600 text-gray-50 rounded-md">New Category</a>
    </div>
                    ...
                    <div class="container px-5 py-24 mx-auto">
                      ...
                      <div class="flex flex-wrap -m-4">
                        ...
                        <div class="lg:w-1/4 md:w-1/2 p-4 w-full m-2 ">
                          <a class="block relative h-48 rounded overflow-hidden" href="{{route('admin.categories.edit',$category->id)}}"> 
