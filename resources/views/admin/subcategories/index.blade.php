<x-admin-layout>
    ...
    <div class="flex justify-end">
        <a href ="{{route('admin.subcategories.create')}}"    class="py-2 px-4 m-2 bg-green-500 hover:bg-green-600 text-gray-50 rounded-md">New SubCategory</a>
    </div>
                    ...
                    <div class="flex flex-wrap -m-4">
                        ...
                        @foreach ($sub_categories as $category)
                            ...
                            <div class="lg:w-1/4 md:w-1/2 p-4 w-full m-2 ">
                                <a class="block relative h-48 rounded overflow-hidden" href="{{route('admin.subcategories.edit',$category->id)}}"> 
